    ...
    <div class="glass-card">
        ...
        <form action="{{ url('/project/'.$project->id) }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="nama_project" class="form-control" value="{{ old('nama_project', $project->nama_project) }}">
            </div>
            ...
            <div class="form-actions">
                ...
                <button type="submit" class="btn btn-glass">Update Project</button>
            </div>
        </form>
    </div>
</div>
